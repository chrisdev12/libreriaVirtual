...
<div class="conteiner">
    <nav class="navbar sticky-top  navbar-expand-lg navbar-dark bg-dark barraNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost/libreriaVirtual/session.php">Inicio<span
                ...
                <li class="mr-3">
                    <a href="session.php">
                        <button class="btn btn-outline-light my-2 my-sm-0" type="submit"><i
                                class="fas fa-user mr-2"></i>Ingreso</button>
                    </a>
                </li>
                <li>
                    <a href="registro/registro_user.php">
                        <button class="btn btn-outline-light my-2 my-sm-0" type="submit"><i
                                class="fas fa-user-plus mr-2"></i>Registrar</button>
                    </a>
                </li>
                <?php
