                ...
                <div class="col-md-6">
                    <form  method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nom_autor" id="nom_autor" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                            <label for="apell_autor">Apellido Autor</label>
                            <input type="text" class="form-control" name="apell_autor" id="apell_autor" placeholder="Password">
                        </div>
